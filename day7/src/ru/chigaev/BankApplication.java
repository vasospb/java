...
public class BankApplication {
    ...
    static void initialize(Bank bank, float[][] initialDeposit) {
        ...
        System.out.println(bank.getClients().get(0).getClientSalutation());
        System.out.println(bank.getClients().get(1).getClientSalutation());
    ...
    static void modifyBank(Bank bank, float[][] depArray, float[][] withdrawArray) {
        ...
        for (int i = 0; i < bank.getClients().size(); i++) {
            for (int x = 0; x < bank.getClients().get(i).getAccounts().size(); x++) {
...
String
    static void test(Bank bank, float[][] initArray, float[][] depArray, float[][] withdrawArray) {
        ...
        for (int i = 0; i < initArray.length; i++) {
            ...
            for (int x = 0; x < initArray[i].length; x++) {
